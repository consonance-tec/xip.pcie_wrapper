...
/// @brief Sets the Max Read Request Size parametre for the channel
/// @param [in] dma_chan
/// @param [in] max_read_req the new max read request 
/// @return Zero on success and -1 on error 
...
/// @return num of devices success and -1 on error 
