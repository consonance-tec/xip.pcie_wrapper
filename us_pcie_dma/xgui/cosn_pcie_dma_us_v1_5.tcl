...
proc init_gui { IPINST } {
  ...
  set C_DATA_WIDTH [ipgui::add_param $IPINST -name "C_DATA_WIDTH" -parent ${Page_0} -widget comboBox]
  set_property tooltip {C2S & S2C Buses Width} ${C_DATA_WIDTH}
  ipgui::add_param $IPINST -name "NUM_OF_C2S_CHAN" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "NUM_OF_INTERRUPTS" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "NUM_OF_S2C_CHAN" -parent ${Page_0} -widget comboBox
